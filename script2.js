  ...
  function maincheck(){
    ...
    if(initialscore!==0){
       ...
       document.querySelector('.message').textContent="Your Guess Is High"
        ...
        document.querySelector('.message').textContent=" Hurray You are the winner Congratulations........!!!"
        ...
        document.querySelector('.message').textContent="Game Over buddy... your score is 0"
